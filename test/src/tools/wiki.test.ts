...
describe("configureWikiTools", () => {
  ...
  describe("tool registration", () => {
    it("registers wiki tools on the server", () => {
      configureWikiTools(server, tokenProvider, connectionProvider, userAgentProvider, false);
    ...
    describe("read-only mode", () => {
      it("removes write tools when in read-only mode", () => {
        ...
        configureWikiTools(server, tokenProvider, connectionProvider, userAgentProvider, true);
